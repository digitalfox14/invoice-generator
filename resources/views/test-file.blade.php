...
<head>
    ...
    <link href="https://d1m57r24ku159u.cloudfront.net/static/vendor.740b15bf.css" type="text/css" rel="stylesheet" />
    <link href="https://d1m57r24ku159u.cloudfront.net/static/app.165fa435.css" type="text/css" rel="stylesheet" />
    ...
    <script type="text/javascript" src="https://d1m57r24ku159u.cloudfront.net/static/vendor.d483569a.js"></script>
    <script type="text/javascript" src="https://d1m57r24ku159u.cloudfront.net/static/app.6aee2ed7.js"></script>
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-WRDBSFP');</script>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WRDBSFP"
                        ...
                        <div class="col">
                            <div class="input-group addon-input">
                                ...
                                <div class="input-group-addon">
                                    <input id="invoiceDate" class="form-control datepicker" type="text" name="date" value="Sep 28, 2021" />
                                </div>
                            </div>
    ...
    <div class="ng-cloak">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="https://invoiced.com/blog">
                                    Blog
                                </a>
                            </li>
                        </ul>
        ...
        <form method="post" action="/csv?source=lite" class="nomargin" id="csv_form" target="_self">
            <input id="csv_json" type="hidden" name="json" />
        </form>
        <form method="post" action="/pdf?source=lite" class="nomargin" id="pdf_form" target="_self">
            <input id="pdf_json" type="hidden" name="json" />
        </form>
        <form method="post" action="/ubl?source=lite" class="nomargin" id="ubl_form" target="_self">
